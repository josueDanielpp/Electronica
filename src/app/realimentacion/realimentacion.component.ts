...
export class RealimentacionComponent {
  ...
  calcularForm1():void{
    ...
    this.ib = (this.vcc-0.7)/(Number(this.rb*1000)+Number((this.aux)*(this.re*1000+this.rc*1000)));
    this.ib *=1000000; 
    ...
    this.ie = Number(this.ib/1000) + Number(this.ic);
